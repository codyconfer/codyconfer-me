...
::: .skills
::: .summary
Full stack solutions engineering with a focus on Microsoft Technologies: C#, .NET Core, Typescript, and Azure. Interested in Serverless and Distributed paradigms. 
:::
::: .skills-grid
...
::: .experience-skills-grid
![c sharp](/skills/csharp.png)
![dot net](/skills/dotnet-framework.png)
![visual studio](/skills/visualstudio.png)
![dev ops](/skills/devops.png)
![azure](/skills/azure.png)
![typescript](/skills/ts.png)
